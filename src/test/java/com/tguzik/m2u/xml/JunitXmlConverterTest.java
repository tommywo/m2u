...
public class JunitXmlConverterTest {
    ...
    public void setUp() throws Exception {
        ...
        this.input = Loader.loadFile( JunitXmlConverterTest.class, "../testdata", "sample-junit-input.xml" );
        this.expected = Loader.loadFile( JunitXmlConverterTest.class, "../testdata", "parsed-junit.txt" );
    }
